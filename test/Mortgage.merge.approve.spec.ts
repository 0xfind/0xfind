...
describe("Mortgage.merge.approve", function () {
  ...
  describe("merge", function () {
    ...
    it("xxx", async function () {
      ...
      await mortgageContract.connect(user1Wallet).approve(user2Wallet.address, info2.tokenId);
      ...
      expect(user2Find4.sub(user2Find3)).eq(
        BigNumber.from("3229293635545081411054")
      );
