...
describe("Earn.collectOspUniswapLPFee.o0", function () {
  ...
  describe("collect", function () {
    ...
    it("collect", async function () {
        ...
        expect(osp1CnftOwnerFind3.sub(osp1CnftOwnerFind2)).eq(collectOspUniswapLPFeeInfo1.cAmount).eq(BigNumber.from("999999999999999999"));
        expect(osp1CnftOwnerOsp3.sub(osp1CnftOwnerOsp2)).eq(0);
        expect(osp1OnftOwnerFind3.sub(osp1OnftOwnerFind2)).eq(0);
        expect(osp1OnftOwnerOsp3.sub(osp1OnftOwnerOsp2)).eq(collectOspUniswapLPFeeInfo1.oAmount).eq(0);
        ...
        expect(osp2CnftOwnerFind2.sub(osp2CnftOwnerFind1)).eq(collectOspUniswapLPFeeInfo2.cAmount).eq(BigNumber.from("10990248140904269808"));
        expect(osp2CnftOwnerOsp2.sub(osp2CnftOwnerOsp1)).eq(0);
        expect(osp2OnftOwnerFind2.sub(osp2OnftOwnerFind1)).eq(0);
        expect(osp2OnftOwnerOsp2.sub(osp2OnftOwnerOsp1)).eq(collectOspUniswapLPFeeInfo2.oAmount).eq(0);
