...
describe("Factory.createOSPAndMultiply.find", function () {
  ...
  describe("createOSPAndMultiply", function () {
    ...
    it("find", async function () {
      ...
      const buyNFTTokenAmountMax = BigNumber.from(10).pow(18).mul(30);
      ...
      expect(staticInfo.nftNeedPay).eq(BigNumber.from(10).pow(18).mul(3));
      ...
      expect(user1Find1.sub(user1Find2)).eq(staticInfo.amountNeedPay.add(staticInfo.nftNeedPay));
