...
describe("Factory.createOSP.usdt", function () {
  ...
  describe("createOSP", function () {
    ...
    it("usdt", async function () {
      ...
      expect(user1Usdt1.sub(user1Usdt2)).eq(staticInfo.nftNeedPay);
      ...
      expect(earnFind2.sub(earnFind1)).eq(buyNFTFindAmount);
      ...
      await expect(
        factoryContract.connect(user1Wallet).createOSP(osp1Params)
      ).revertedWith("E");
