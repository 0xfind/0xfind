...
describe("Factory.createOSP.matic", function () {
  ...
  describe("createOSP", function () {
    ...
    it("matic", async function () {
      ...
      const staticInfo = await factoryContract
        .connect(user1Wallet)
        .callStatic.createOSP(
          osp1Params,
          { value: osp1Params.buyNFTTokenAmountMax }
        );
      ...
      const t1 = await factoryContract
        ...
        .createOSP(
          osp1Params,
          { gasPrice: gasPrice, value: osp1Params.buyNFTTokenAmountMax }
        );
      ...
      osp1Params.buyNFTTokenAmountMax = staticInfo.nftNeedPay.sub(1);
      osp1Params.signature = await signatureWallet.signMessage(
        ethers.utils.arrayify(
          ethers.utils.keccak256(
            ethers.utils.defaultAbiCoder.encode(
