...
describe("OspPool.ospFind.1.buy", function () {
  let wallets;
  ...
  it("buy", async function () {
    ...
    // buy 1 osp
    const buy1info = await buyOsp(BigNumber.from(10).pow(18).mul(1));
    expect(buy1info.osp).eq(BigNumber.from(10).pow(18).mul(1));
