...
describe("Earn.collectForBuilder.c0", function () {
  ...
  describe("claim collect", function () {
    ...
    it("collect", async function () {
      ...
      expect(await findContract.balanceOf(earnContract.address)).eq(0);
        ...
        expect(findcnftOwnerFind_4.sub(findcnftOwnerFind_3)).eq(collectForBuilderFind_3.cAmount).eq(0);
        expect(findonftOwnerFind_4.sub(findonftOwnerFind_3)).eq(collectForBuilderFind_3.oAmount);

        expect(earnContractFind_3.sub(earnContractFind_4))
            .eq(collectForBuilderFind_3.oAmount)
