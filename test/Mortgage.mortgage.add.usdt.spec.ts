...
describe("Mortgage.mortgage.add.usdt", function () {
  ...
  describe("mortgage", function () {
    ...
    it("xxx", async function () {
      ...
      const user2Usdt1 = await usdtContract.balanceOf(user2Wallet.address);
      const earnUsdt1 = await usdtContract.balanceOf(earnContract.address);
      const mortgageUsdt1 = await usdtContract.balanceOf(mortgageContract.address);
      ...
      const user2MortgageInfo = await mortgageContract
        .connect(user2Wallet)
        .callStatic.mortgage(osp1.address, ospAmount5, findToUsdtInPath);
      ...
      await mortgageContract
        .connect(user2Wallet)
        .mortgage(osp1.address, ospAmount1.mul(2), findToUsdtInPath);
      ...
      await mortgageContract
        .connect(user2Wallet)
        .mortgageAdd(user2MortgageInfo.tokenId, ospAmount1.mul(2), findToUsdtInPath);
      ...
      await mortgageContract
        .connect(user2Wallet)
        .mortgageAdd(user2MortgageInfo.tokenId, ospAmount1.mul(1), findToUsdtInPath);
      ...
      const user2Usdt2 = await usdtContract.balanceOf(user2Wallet.address);
      const earnUsdt2 = await usdtContract.balanceOf(earnContract.address);
      const mortgageUsdt2 = await usdtContract.balanceOf(mortgageContract.address);
      ...
      console.log(1);
      console.log(user2Usdt2.sub(user2Usdt1))
      console.log(user2MortgageInfo.amountOut)
      console.log(user2MortgageInfoSplit1.amountOut
        .add(user2MortgageInfoSplit2.amountOut)
        .add(user2MortgageInfoSplit3.amountOut))

      expect(user2Usdt2.sub(user2Usdt1))
      .eq(user2MortgageInfo.amountOut.sub(1))
      .eq(
        user2MortgageInfoSplit1.amountOut
          .add(user2MortgageInfoSplit2.amountOut)
          .add(user2MortgageInfoSplit3.amountOut)
      );
      expect(earnUsdt2).eq(earnUsdt1).eq(0);
      expect(mortgageUsdt2).eq(mortgageUsdt1).eq(0);
      ...
      console.log("usdt", user2MortgageInfo.amountOut.add(1));
      ...
      expect(user2MortgageInfoSplit1.tokenOut).eq(usdtContract.address);
      expect(user2MortgageInfoSplit2.tokenOut).eq(usdtContract.address);
      expect(user2MortgageInfoSplit3.tokenOut).eq(usdtContract.address);
