...
import { UNISWAP_V3_POSITIONS, deployAllContractFindWeth, ZERO_ADDRESS } from "./share/utils";

import { SignerWithAddress } from "@nomiclabs/hardhat-ethers/signers";

describe("FindPool.wethFind.init", function () {
  let wallets;
  ...
  it("find lp token info", async function () {
    ...
    console.log("0 is weth, 1 is find");
    expect(position.token0).eq(wethContract.address)
