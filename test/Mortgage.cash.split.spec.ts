...
describe("Mortgage.cash", function () {
  ...
  describe("cash", function () {
    ...
    it("xxx", async function () {
      ...
      expect(user1Find4.sub(user1Find3))
      .eq(
      ...
      expect(cashInfoSplit1.tokenOut).eq(findContract.address);
      expect(cashInfoSplit2.tokenOut).eq(findContract.address);
      expect(cashInfoSplit3.tokenOut).eq(findContract.address);
