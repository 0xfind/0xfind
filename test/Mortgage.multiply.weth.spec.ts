...
describe("Mortgage.multiply.weth", function () {
  ...
  describe("multiply", function () {
    ...
    it("xxx", async function () {
      ...
      expect(info.amountNeedPay).eq(inWeth);
      expect(info.tokenPay).eq(wethContract.address);
