...
describe("Factory.createOSPByProjectOwnerAndMultiply.find", function () {
  ...
  describe("createOSPByProjectOwnerAndMultiply", function () {
    ...
    it("find", async function () {
      ...
      const amountPayMax = BigNumber.from("1609387179011089915998");
      ...
      expect(await findContract.totalSupply())
        .eq(
          findOldTotalSupply
            .add(AllFindAmount)
            .sub(staticInfo.amountNeedPay.sub(earnFind2.sub(earnFind1)))
        )
