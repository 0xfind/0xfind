...
describe("Mortgage.mortgage.add.weth", function () {
  ...
  describe("mortgage", function () {
    ...
    it("xxx", async function () {
      ...
      const mortgageWeth1 = await wethContract.balanceOf(mortgageContract.address);
      ...
      await mortgageContract
        .connect(user2Wallet)
        .mortgage(osp1.address, ospAmount1.mul(2), findToWethInPath);
      ...
      await mortgageContract
        .connect(user2Wallet)
        .mortgageAdd(user2MortgageInfo.tokenId, ospAmount1.mul(2), findToWethInPath);
      ...
      await mortgageContract
        .connect(user2Wallet)
        .mortgageAdd(user2MortgageInfo.tokenId, ospAmount1.mul(1), findToWethInPath);
      ...
      const mortgageWeth2 = await wethContract.balanceOf(mortgageContract.address);
      ...
      console.log(1);
      console.log(user2Weth2.sub(user2Weth1))
      ...
      expect(user2Weth2.sub(user2Weth1))
      .eq(user2MortgageInfo.amountOut.sub(799))
      .eq(
      ...
      console.log("weth", user2MortgageInfo.amountOut.add(1));
      ...
      expect(user2MortgageInfoSplit1.tokenOut).eq(wethContract.address);
      expect(user2MortgageInfoSplit2.tokenOut).eq(wethContract.address);
      expect(user2MortgageInfoSplit3.tokenOut).eq(wethContract.address);
