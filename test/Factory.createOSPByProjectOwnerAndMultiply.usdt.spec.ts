...
describe("Factory.createOSPByProjectOwnerAndMultiply.usdt", function () {
  ...
  describe("createOSPByProjectOwnerAndMultiply", function () {
    ...
    it("usdt", async function () {
      ...
      await usdtContract
        .connect(user1Wallet)
        .approve(factoryContract.address, amountPayMax);
      ...
      expect(user1Usdt1.sub(user1Usdt2)).eq(staticInfo.amountNeedPay);
