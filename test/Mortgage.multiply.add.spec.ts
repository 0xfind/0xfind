...
describe("Mortgage.multiply.split", function () {
  ...
  describe("multiply", function () {
    ...
    it("xxx", async function () {
      ...
      expect(user2Find1.sub(user2Find2))
        .eq(user2MultiplyInfo.amountNeedPay.add(1))
        .eq(
      ...
      expect(user2MultiplyInfoSplit1.tokenPay).eq(findContract.address);
      expect(user2MultiplyInfoSplit2.tokenPay).eq(findContract.address);
      expect(user2MultiplyInfoSplit3.tokenPay).eq(findContract.address);
