...
describe("Mortgage.multiply.add.matic", function () {
    ...
    it("xxx", async function () {
      ...
      const t1 = await mortgageContract
        ...
        .multiply(
          ...
          user2amountPayMax1,
          maticToFindOutPath,
          {value: user2amountPayMax1, gasPrice: gasPrice}
        );
      ...
      const user2MultiplyInfoSplit2 = await mortgageContract
        ...
        .multiplyAdd(
          ...
          user2amountPayMax2,
          maticToFindOutPath,
          {value: user2amountPayMax2, gasPrice: gasPrice}
        );
      ...
      const user2MultiplyInfoSplit3 = await mortgageContract
        ...
        .multiplyAdd(
          ...
          user2amountPayMax3,
          maticToFindOutPath,
          {value: user2amountPayMax3, gasPrice: gasPrice}
        );
      ...
      .eq(user2MultiplyInfo.amountNeedPay.add(406632))
      .eq(
      ...
      expect(user2MultiplyInfoSplit1.tokenPay).eq(wmatic.address);
      expect(user2MultiplyInfoSplit2.tokenPay).eq(wmatic.address);
      expect(user2MultiplyInfoSplit3.tokenPay).eq(wmatic.address);

      console.log("matic", user2MultiplyInfo.amountNeedPay);
